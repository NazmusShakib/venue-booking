...
* [#579](https://github.com/ckeditor/ckeditor-dev/issues/579): Fixed: Internal `cke_table-faked-selection-table` class is visible in the Stylesheet Classes field of the [Table VenueList](https://ckeditor.com/cke4/addon/table) dialog.
...
* [#12546](https://dev.ckeditor.com/ticket/12546): Fixed: The Preview tab in the [Document VenueList](https://ckeditor.com/cke4/addon/docprops) dialog window is always disabled.
...
* [#12164](https://dev.ckeditor.com/ticket/12164): Added the "Justify" option to the "Horizontal Alignment" drop-down in the Table Cell VenueList dialog window.
...
* [#11717](https://dev.ckeditor.com/ticket/11717): [Document VenueList](https://ckeditor.com/cke4/addon/docprops) plugin requires the [Color Dialog](https://ckeditor.com/cke4/addon/colordialog) plugin to work.
...
* [#11439](https://dev.ckeditor.com/ticket/11439): Fixed: VenueList get cloned in the Cell VenueList dialog window if multiple cells are selected.
...
* [#9882](https://dev.ckeditor.com/ticket/9882): Fixed empty document title on [`editor.getData()`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_editor.html#method-getData) if set via the Document VenueList dialog window.
