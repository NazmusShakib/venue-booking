                                ...
                                <div className="filter-wrap margin-bottom-30px">
                                    <div className="filter-top d-flex align-items-center justify-content-between pb-4">
                                        <div>
                                            ...
                                            <p className="font-size-14"><span className="mr-1 pt-1">Book with confidence:</span>No venues booking fees</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">Best Western Grant Park Hotels</a></h3>
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">Four Seasons Resort Maui at Wailea</a></h3>
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">Ibis Styles London Heathrow</a></h3>
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">Hotels Europe Saint Severin Paris</a></h3>
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">EnVision Hotels Boston</a></h3>
                                                <p className="card-meta"> Boston, MA, USA</p>
                                                <div className="card-rating">
                                                    <span className="badge text-white">4.4/5</span>
                                                    <span className="review__text">Average</span>
                                                    <span className="rating__text">(30 Reviews)</span>
                                    ...
                                    <div className="col-lg-6 responsive-column">
                                        <div className="card-item">
                                            ...
                                            <div className="card-body">
                                                <h3 className="card-title"><a href="hotel-single.html">Parian Holiday Villas</a></h3>
                                                <p className="card-meta">Virginia, USA</p>
                                                <div className="card-rating">
                                                    <span className="badge text-white">4.4/5</span>
                                                    <span className="review__text">Average</span>
                                                    <span className="rating__text">(30 Reviews)</span>
                                ...
                                <div className="sidebar mb-0">
                                    ...
                                    <div className="sidebar-widget">
                                        ...
                                        <div className="sidebar-category">
                                            ...
                                            <a className="btn-text" data-toggle="collapse" href="#facilitiesMenu" role="button" aria-expanded="false" aria-controls="facilitiesMenu">
                                                <span className="show-more">Show More <i className="la la-angle-down"></i></span>
                                                <span className="show-less">Show Less <i className="la la-angle-up"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                    <div className="sidebar-widget">
                                        <h3 className="title stroke-shape">Resorts Theme</h3>
                                        <div className="sidebar-category">
                                            <div className="custom-checkbox">
                                            ...
                                            <a className="btn-text" data-toggle="collapse" href="#hotelThemeMenu" role="button" aria-expanded="false" aria-controls="hotelThemeMenu">
                                                <span className="show-more">Show More <i className="la la-angle-down"></i></span>
                                                <span className="show-less">Show Less <i className="la la-angle-up"></i></span>
                                            </a>
                                        </div>
