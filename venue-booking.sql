...
--
-- Host: localhost:3306
-- Generation Time: Aug 19, 2022 at 01:18 PM
...
(8, 0, 17, 'Calendar', 'fa-calendar', 'calendar', '*', '2022-06-29 10:27:37', '2022-08-13 00:08:41'),
...
(17, 0, 18, 'Users', 'fa-users', '/users', '*', '2022-07-28 22:05:57', '2022-08-13 00:08:41'),
(18, 0, 16, 'Orders', 'fa-cart-arrow-down', '/orders', '*', '2022-08-13 00:08:32', '2022-08-13 00:08:41');
...
(41, '2022_07_01_115642_create_venues_table', 11);
...
CREATE TABLE `users` (
  ...
  `type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=>Default User, 1=>Venue Admin User',
  `venue_id` text COLLATE utf8mb4_unicode_ci,
  `remember_token` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
